...
describe('reldate', () => {
  it('should format less-than-hours as hours', () => {
    ...
    const result = reldate(twoMinutesAgo, 'en-us');
  ...
  it('should format hours', () => {
    ...
    const result = reldate(twoHoursAgo, 'en-us');
  ...
  it('should format days', () => {
    ...
    const result = reldate(threeDaysAgo, 'en-us');
  ...
  it('should format weeks', () => {
    ...
    const result = reldate(twoWeeksAgo, 'en-us');
  ...
  it('should format months', () => {
    ...
    const result = reldate(threeMonthsAgo, 'en-us');
  ...
  it('should format years', () => {
    ...
    const result = reldate(twoYearsAgo, 'en-us');
  ...
  it('should handle future dates', () => {
    ...
    const result = reldate(inTwoHours, 'en-us');
